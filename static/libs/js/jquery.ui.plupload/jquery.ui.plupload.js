			...
			'<div class="ui-widget-content plupload_container">' +
				'<div class="ui-state-default ui-widget-header plupload_header">' +
					'<div class="plupload_header_content">' +
						...
						'<div class="plupload_header_title">' + _("Uploader for Research") + '</div>' +
				...
				'<div class="plupload_content">' +
					'<div class="plupload_droptext">' + 
						_("Add or drag files here and click the start button.") + 
						'<ul class="droptext-tips">' +
							'<li>Only Excel files can be selected for upload</li>' + 
							'<li>A maximum of 10 files can be uploaded at a time</li>' + 
							'<li>Individual file size should not exceed 100M</li>' + 
						'</ul>' +
					'</div>' +
